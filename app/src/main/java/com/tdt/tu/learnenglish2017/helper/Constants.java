...
public class Constants {
    ...
    public static String URL_ALL_COURSES = ROOT_URL + "get_all_courses.php";

    public static String URL_ALL_LESSONS = ROOT_URL + "get_lessons_info.php";

    public static String URL_ALL_QUESTIONS = ROOT_URL + "get_all_questions.php";

    public static String URL_ALL_CATEGORIES = ROOT_URL + "get_all_categories.php";
